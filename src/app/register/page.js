...
export default function Register() {
  ...
  return (
    <div className="grid grid-cols-5 relative">
      ...
      <Image
        className="absolute ml-[500px] mt-[600px]"
        width={150}
        height={150}
        src={onion}
        alt="onion"
            ...
            <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
              <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form className="space-y-4 md:space-y-6">
                  ...
                  <button
                      type="submit"
                      class="w-full bg-primary py-3 rounded-md text-white font-bold transition-all duration-300 hover:bg-white hover:text-black hover:border-2 border-2 border-primary hover:border-primary"
                    >
                      Create An Account
                    </button>
