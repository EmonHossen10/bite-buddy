...
export default function Register() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-5 relative">
      <div className="bg-white flex justify-center items-center col-span-2">
        <div className="space-y-3 mt-24">
          <h1 className="text-3xl md:text-4xl font-bold text-center md:text-left">
            Welcome to <span className="text-primary">BiteBuddy!</span>
          </h1>
          <p className="text-center md:text-left">
            Welcome to best food ordering app
          </p>
          <Image
      ...
      <Image
        className="absolute mt-[370px] md:ml-[500px] md:mt-[670px] w-[50px] h-[60px] md:w-[150px] md:h-[160px]"
        src={onion}
        alt="onion"
      ></Image>
      <Image
        className="absolute w-[90px] h-[110px] md:w-[150px] md:h-[230px]"
        src={veg}
        alt="vegetable"
      ></Image>
      <Image
        className="absolute mt-[370px] md:mt-0 ml-[280px] lg:ml-[1220px] w-[80px] h-[190px] md:w-[250px] md:h-[450px]"
        src={milk}
        alt="milk"
      ></Image>
              ...
              <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form className="space-y-4 md:space-y-6">
                  ...
                  <div className="relative">
                    ...
                    <input
                      onChange={handlePass}
                      type={toglePassword ? "password" : "text"}
                    ...
                    {password ? (
                      <label className="swap absolute -mt-8 ml-[350px] ">
                        ...
                        <FaEye
                          ...
                          className="swap-on fill-current text-white text-xl"
                        ></FaEye>
                        {/* volume off icon */}
                        <FaEyeSlash
                          onClick={handleShowPass}
                          className="swap-off fill-current text-white text-xl"
                        ></FaEyeSlash>
                      </label>
                    ) : (
                      <></>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      type={toglePassword1 ? "password" : "text"}
                      name="password"
                      id="password"
                      placeholder="••••••••"
                      className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  ...
                  <button
                    type="submit"
                    className=" bg-primary  text-white w-full py-2 rounded border hover:bg-white hover:text-black hover:border-primary transition-all font-semibold "
                  >
                    Create an account
                  </button>
